...
execSync(`(copy README.md .\\linux-${version}-arm64\\polyn) && (copy LICENSE .\\linux-${version}-arm64\\polyn)`, { stdio: "inherit" });
...
execSync(`(copy .\\emb\\7z\\linux\\arm\\7zzs .\\linux-${version}-arm64\\polyn\\emb\\7z\\linux\\arm) && (copy .\\emb\\7z\\linux\\arm\\License.txt .\\linux-${version}-arm64\\polyn\\emb\\7z\\linux\\arm)`, { stdio: "inherit" });
...
execSync(`(copy README.md .\\linux-${version}-x64\\polyn) && (copy LICENSE .\\linux-${version}-x64\\polyn)`, { stdio: "inherit" });
...
execSync(`(copy .\\emb\\7z\\linux\\x64\\7zzs .\\linux-${version}-x64\\polyn\\emb\\7z\\linux\\x64) && (copy .\\emb\\7z\\linux\\x64\\License.txt .\\linux-${version}-x64\\polyn\\emb\\7z\\linux\\x64)`, { stdio: "inherit" });
...
execSync(`(copy README.md .\\darwin-${version}-x64\\polyn) && (copy LICENSE .\\darwin-${version}-x64\\polyn)`, { stdio: "inherit" });
...
execSync(`(copy README.md .\\win-${version}-x64\\polyn) && (copy LICENSE .\\win-${version}-x64\\polyn)`, { stdio: "inherit" });
